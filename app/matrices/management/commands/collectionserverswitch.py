...
#
# ##
# \file         collectionserverswitch.py
# \author       Mike Wicks
# \date         March 2021
# \version      $Id$
# \par
...
# \brief
# This file contains the Collection Server Switch admin command USING a Task if possible
# ##
#
...
#
#   The Collection Server Switch admin command
#
class Command(BaseCommand):

    help = "Switch All Images in a Collection to a New Server USING a Task"
    ...
    def handle(self, *args, **options):
        ...
        collection = Collection.objects.get_or_none(id=int(collection_id))

        if collection:

            images = collection.get_all_images()
            ...
            for image in images:
                    ...
                    if old_server.is_omero547():
                        ...
                        if environment.is_web_gateway() or old_server.is_idr():
                            ...
                            if environment.is_blitz_gateway():
                                ...
                                old_server_data = old_server.get_imaging_server_image_json_blitz(
                                    image.identifier, environment.gateway_port)
                    ...
                    if new_server.is_omero547():
                        ...
                        if environment.is_web_gateway() or new_server.is_idr():
                            ...
                            if environment.is_blitz_gateway():
                                ...
                                new_server_data = new_server.get_imaging_server_image_json_blitz(
                                    image.identifier, environment.gateway_port)
                ...
                if update is True and old_server_present is False and new_server_present is True:
                    ...
                    if environment.is_background_processing():
                        ...
                        out_message = "Program collectionserverswitch UPDATE: Image " + str(image.id) + \
                    ...
                    out_message = "Program collectionserverswitch NO UPDATE!"
                    self.stdout.write(self.style.SUCCESS(out_message))

        out_message = "Program : collectionserverswitch Complete!!"
        self.stdout.write(self.style.SUCCESS(out_message))
