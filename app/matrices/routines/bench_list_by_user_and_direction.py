...
def bench_list_by_user_and_direction(a_user,
    ...
    if a_user.is_superuser:
        ...
        if a_query_search_term == '':
            ...
            if a_query_created_after == '' and a_query_created_before == '' and a_query_modified_after == '' and \
               a_query_modified_before == '':
                ...
                if a_query_title == '' and a_query_description == '' and str_query_owner == '' and \
                   str_query_authority == '':
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN'))\
                        .order_by(sort_parameter)

                if a_query_title == '' and a_query_description == '' and str_query_owner == '' and \
                   str_query_authority != '':
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN'))\
                        .filter(matrix_authorisation_authority=str_query_authority)\
                        .order_by(sort_parameter)

                if a_query_title == '' and a_query_description == '' and str_query_owner != '' and \
                   str_query_authority == '':
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN'))\
                        .filter(matrix_owner=str_query_owner)\
                        .order_by(sort_parameter)
                ...
                if a_query_title == '' and a_query_description != '' and str_query_owner == '' and \
                   str_query_authority == '':
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN') &
                                                            Q(matrix_description__icontains=a_query_description))\
                        .order_by(sort_parameter)
                ...
                if a_query_title != '' and a_query_description == '' and str_query_owner == '' and \
                   str_query_authority == '':
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN') &
                                                            Q(matrix_title__icontains=a_query_title))\
                        .order_by(sort_parameter)
                ...
                if a_query_created_after == '' and a_query_created_before == '' and a_query_modified_after == '' and \
                   a_query_modified_before != '':
                    ...
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN')).filter(
                        matrix_modified__lte=date_modified_before).order_by(sort_parameter)

                if a_query_created_after == '' and a_query_created_before == '' and a_query_modified_after != '' and \
                   a_query_modified_before == '':
                    date_modified_after = datetime.datetime.strptime(a_query_modified_after, '%d/%m/%Y %H:%M')
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN')).filter(
                        matrix_modified__gte=date_modified_after).order_by(sort_parameter)
                ...
                if a_query_created_after == '' and a_query_created_before == '' and a_query_modified_after != '' and \
                   a_query_modified_before != '':
                    ...
                    date_modified_after = datetime.datetime.strptime(a_query_modified_after, '%d/%m/%Y %H:%M')
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN'))\
                        .filter(matrix_modified__lte=date_modified_before)\
                        .filter(matrix_modified__gte=date_modified_after)\
                        .order_by(sort_parameter)
                ...
                if a_query_created_after == '' and a_query_created_before != '' and a_query_modified_after == '' and \
                   a_query_modified_before == '':
                    ...
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN'))\
                        .filter(matrix_created__lte=date_created_before)\
                        .order_by(sort_parameter)
                ...
                if a_query_created_after != '' and a_query_created_before == '' and a_query_modified_after == '' and \
                   a_query_modified_before == '':
                    ...
                    queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN'))\
                        .filter(matrix_created__gte=date_created_after)\
                        .order_by(sort_parameter)
            ...
            queryset = MatrixSummary.objects.filter(Q(matrix_authorisation_authority='ADMIN') &
                                                    (Q(matrix_title__icontains=a_query_search_term) |
                                                     Q(matrix_description__icontains=a_query_search_term)))\
                .order_by(sort_parameter)
            ...
            if a_query_created_after == '' and a_query_created_before == '' and a_query_modified_after == '' and \
               a_query_modified_before == '':
                ...
                if a_query_title == '' and a_query_description == '' and str_query_owner == '' and \
                   str_query_authority == '':
                    queryset = MatrixSummary.objects.filter(~Q(matrix_authorisation_authority='ADMIN') &
                                                            Q(matrix_authorisation_permitted=a_user.username))\
                        .order_by(sort_parameter)
