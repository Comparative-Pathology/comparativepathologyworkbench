    ...
    if a_user.is_superuser:
        ...
        if a_query_search_term == '':
            ...
            if a_query_title == '' and a_query_description == '' and str_query_owner == '' and \
               str_query_authority != '':
                queryset = CollectionSummary.objects.filter(Q(collection_authorisation_authority='ADMIN'))\
                    .filter(collection_authorisation_authority=str_query_authority)\
                    .order_by(sort_parameter)

            if a_query_title == '' and a_query_description == '' and str_query_owner != '' and \
               str_query_authority == '':
                queryset = CollectionSummary.objects.filter(Q(collection_authorisation_authority='ADMIN'))\
                    .filter(collection_owner=str_query_owner)\
                    .order_by(sort_parameter)
            ...
            if a_query_title == '' and a_query_description != '' and str_query_owner == '' and \
               str_query_authority == '':
                queryset = CollectionSummary.objects.filter(Q(collection_authorisation_authority='ADMIN') &
                                                            Q(collection_description__icontains=a_query_description))\
                    .order_by(sort_parameter)
            ...
            if a_query_title != '' and a_query_description == '' and str_query_owner == '' and \
               str_query_authority == '':
                queryset = CollectionSummary.objects.filter(Q(collection_authorisation_authority='ADMIN') &
                                                            Q(collection_title__icontains=a_query_title))\
                    .order_by(sort_parameter)
