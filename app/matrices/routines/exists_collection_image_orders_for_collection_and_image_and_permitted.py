...
#
# ##
# \file         exists_collection_image_orders_for_collection_and_image_and_permitted.py
# \author       Mike Wicks
# \date         March 2021
# \version      $Id$
# \par
...
#
def exists_collection_image_orders_for_collection_and_image_and_permitted(a_collection, a_image, a_permitted):
    ...
    return CollectionImageOrder.objects.filter(collection=a_collection)\
        .filter(image=a_image).filter(permitted=a_permitted).exists()
