...
#   views/ajax
	...
	path('active_collection_selection/<int:user_id>/', matrices_views.ajax.active_collection_selection, name='active_collection_selection'),
...
#   views/gallery
	...
	path('add_dataset_all/<int:server_id>/<int:dataset_id>/', matrices_views.gallery.add_dataset_all, name='webgallery_add_dataset_all'),
	path('add_dataset_all_filtered/<int:server_id>/<int:dataset_id>/', matrices_views.gallery.add_dataset_all_filtered, name='webgallery_add_dataset_all_filtered'),
	path('add_dataset_all_new_collection/<int:server_id>/<int:dataset_id>/', matrices_views.gallery.add_dataset_all_new_collection, name='webgallery_add_dataset_all_new_collection'),
	path('add_dataset_all_filtered_new_collection/<int:server_id>/<int:dataset_id>/', matrices_views.gallery.add_dataset_all_filtered_new_collection, name='webgallery_add_dataset_all_filtered_new_collection'),
