...
# \brief
#
# This file contains the add_dataset_all view routine
#
###
...
#
# Add ALL the images from a Dataset to a Collection
#
@login_required
def add_dataset_all(request, server_id, dataset_id):
