...
#
# ##
# \file         add_dataset_all_new_collection.py
# \author       Mike Wicks
# \date         March 2021
# \version      $Id$
# \par
...
# \brief
# This file contains the add_dataset_all_new_collection view routine
# ##
#
...
#
@login_required
def add_dataset_all_new_collection(request, server_id, dataset_id):
    ...
    if credential:
        ...
        if server:
            ...
            if exists_collection_for_user_and_title(request.user, dataset_title):

                collection = get_collection_for_user_and_title(request.user, dataset_title)

            else:

                collection = Collection.create(dataset_title, dataset_title, request.user)
                collection.save()
