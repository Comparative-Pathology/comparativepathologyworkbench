...
from .routines import AESCipher
...
class Server(models.Model):
    ...
    def get_wordpress_post(self, post_id):
        ...
        get_post_url = blogGetPost.protocol.name + '://' + self.url + '/' + blogGetPost.application + '/' + blogGetPost.preamble + '/' + post_id
    ...
    def get_wordpress_post_comments(self, post_id):
        ...
        get_post_comments_url = blogGetPostComments.protocol.name + '://' + self.url + '/' + blogGetPostComments.application + '/' + blogGetPostComments.preamble + post_id
    ...
    def post_wordpress_post(self, user_name, title, content):
        ...
        post_a_post_url = blogPostAPost.protocol.name + '://' + self.url + '/' + blogPostAPost.application + '/' + blogPostAPost.preamble
    ...
    def post_wordpress_comment(self, user_name, post_id, content):
        ...
        post_a_comment_url = blogPostAComment.protocol.name + '://' + self.url + '/' + blogPostAComment.application + '/' + blogPostAComment.preamble
    ...
    def delete_wordpress_post(self, user_name, post_id):
        ...
        delete_post_url = blogDeletePost.protocol.name + '://' + self.url + '/' + blogDeletePost.application + '/' + blogDeletePost.preamble + '/' + post_id
    ...
    def get_wordpress_json(self, request, page_id):
        ...
        images_url = commandWordpressImages.protocol.name + '://' + self.url + '/' + commandWordpressImages.application + '/' + commandWordpressImages.preamble + page_id + commandWordpressImages.postamble + str(credential.wordpress)
    ...
    def get_wordpress_image_json(self, request, image_id):
        ...
        image_url = commandWordpressImage.protocol.name + '://' + self.url + '/' + commandWordpressImage.application + '/' + commandWordpressImage.preamble + '/' + image_id
    ...
    def get_imaging_server_json(self, request):
        ...
        api_url = commandAPI.protocol.name + '://' + self.url + '/' + commandAPI.application
        token_url = commandToken.protocol.name + '://' + self.url + '/' + commandToken.application + '/'
        login_url = commandLogin.protocol.name + '://' + self.url + '/' + commandLogin.application + '/'
        
        projects_url = commandProjects.protocol.name + '://' + self.url + '/' + commandProjects.application + '/' + commandProjects.preamble
        group_projects_url = commandGroupProjects.protocol.name + '://' + self.url + '/' + commandGroupProjects.application + '/' + commandGroupProjects.preamble
        datasets_url = commandGroupDatasets.protocol.name + '://' + self.url + '/' + commandGroupDatasets.application + '/' + commandGroupDatasets.preamble
        images_url = commandGroupImages.protocol.name + '://' + self.url + '/' + commandGroupImages.application + '/' + commandGroupImages.preamble
        dataset_images_url = commandDatasetImages.protocol.name + '://' + self.url + '/' + commandDatasetImages.application + '/' + commandDatasetImages.preamble
                            ...
                            for d in dataset_data['data']:
                                ...
                                if dataset_image_rsp.status_code == 200:
                                    ...
                                    if imageCount > 0:
                                        ...
                                        randomImageBEURL = commandBirdsEye.protocol.name + '://' + self.url + '/' + commandBirdsEye.application + '/' + commandBirdsEye.preamble + '/' + str(randImageID) + '/' + commandBirdsEye.postamble
    ...
    def get_imaging_server_group_json(self, request, group_id):
        ...
        groups_url = commandGroupProjects.protocol.name + '://' + self.url + '/' + commandGroupProjects.application + '/' + commandGroupProjects.preamble
        projects_url = commandProjects.protocol.name + '://' + self.url + '/' + commandProjects.application + '/' + commandProjects.preamble + '/'
        datasets_url = commandProjectsDatasets.protocol.name + '://' + self.url + '/' + commandProjectsDatasets.application + '/' + commandProjectsDatasets.preamble + '/'
        
        images_url = commandDatasetImages.protocol.name + '://' + self.url + '/' + commandDatasetImages.application + '/' + commandDatasetImages.preamble + '/'
    ...
    def get_imaging_server_dataset_json(self, request, dataset_id):
        ...
        datasets_url = commandDataset.protocol.name + '://' + self.url + '/' + commandDataset.application + '/' + commandDataset.preamble + '/'
        projects_url = commandDatasetProjects.protocol.name + '://' + self.url + '/' + commandDatasetProjects.application + '/' + commandDatasetProjects.preamble + '/'
        images_url = commandDatasetImages.protocol.name + '://' + self.url + '/' + commandDatasetImages.application + '/' + commandDatasetImages.preamble + '/'
        ...
        for i in idata:
            ...
            if userid == "":
                image_viewer_url = commandViewer.protocol.name + '://' + self.url + '/' + commandViewer.application + '/' + commandViewer.preamble + '/' + image_id
            else:
                image_viewer_url = commandViewer.protocol.name + '://' + self.url + '/' + commandViewer.application + '/' + commandViewer.preamble + image_id
    
            image_birdseye_url = commandBirdsEye.protocol.name + '://' + self.url + '/' + commandBirdsEye.application + '/' + commandBirdsEye.preamble + '/' + image_id + '/' + commandBirdsEye.postamble
            image_thumbnail_url = commandThumbnail.protocol.name + '://' + self.url + '/' + commandThumbnail.application + '/' + commandThumbnail.preamble + '/' + image_id 
    ...
    def get_imaging_server_image_json(self, request, image_id):
        ...
        images_url = commandImages.protocol.name + '://' + self.url + '/' + commandImages.application + '/' + commandImages.preamble + '/'
        datasets_url = commandImageDatasets.protocol.name + '://' + self.url + '/' + commandImageDatasets.application + '/' + commandImageDatasets.preamble + '/'
        imagerois_url = commandImageROIs.protocol.name + '://' + self.url + '/' + commandImageROIs.application + '/' + commandImageROIs.preamble + '/'
        ...
        image_region_url = commandRegion.protocol.name + '://' + self.url + '/' + commandRegion.application + '/' + commandRegion.preamble + '/' + image_id + '/' + commandRegion.postamble
