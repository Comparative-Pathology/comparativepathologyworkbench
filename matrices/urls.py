...
#   views_matrix.py
	...
	path('<int:matrix_id>/add_column/', matrices_views.add_column, name='add_column'),
	...
	path('<int:matrix_id>/delete_column/', matrices_views.delete_column, name='delete_column'),
	path('<int:matrix_id>/add_row/', matrices_views.add_row, name='add_row'),
	...
	path('<int:matrix_id>/delete_row/', matrices_views.delete_row, name='delete_row'),
