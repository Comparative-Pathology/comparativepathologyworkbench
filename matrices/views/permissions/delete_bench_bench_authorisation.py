...
# \brief
# This file contains the delete_bench_bench_authorisation view routine
###
...
#
@login_required
def delete_bench_bench_authorisation(request, matrix_id, bench_authorisation_id):
    ...
    return redirect('list_bench_bench_authorisation', matrix_id=matrix_id)
